...
//mountain name, description, elevation/

let mountainNameselectEl = document.getElementById("mountains-information");
// let descriptionEl = document.getElementById("description");
// let elevationEl = document.getElementById("elevation");

window.onload = function () {
    mountainNameselectEl.innerHTML = "";

    mountainsArray.forEach((mountain) => {
        let optionEl = document.createElement("option");
        optionEl.value = mountain.name;
        optionEl.textContent = mountain.name;
        mountainNameselectEl.appendChild(optionEl);

        for (let mountains of mountains) {
            if (mountains.name === mountainNameselectEl) {

                let mountainNameEl = document.createElement("p");
                mountainNameEl.textContent = mountains.name;
                mountainNameEl.appendChild(mountainNameEl);

                let descriptionEl = document.createElement("p");
                descriptionEl.textContent = mountains.description;
                mountainNameEl.appendChild(descriptionEl);

                let elevationEl = document.createElement("p");
                elevationEl.textContent = mountains.name;
                elevationEl.appendChild(elevationEl);
...
// selectDescriptionEl.style.visibility = "visible";
// selectDescriptionEl.options.length = 0;
