    ...
    let locationSelectEl = document.getElementById("nationalParks");
        let parkSelectEl = document.getElementById("parkTypes");
          let parksPlaceholderEl = document.getElementById("parkPlaceholder"); 

    window.onload = function () {
        for (let i = 0; i < locationsArray.length; i++) {
          let location = locationsArray[i];
          let locationOptionEl = new Option(location);
          locationSelectEl.appendChild(locationOptionEl);
        }
        ...
        //   }
          ...
          let matchingLocation = nationalParksArray.filter((park) => {
            return park.State === locationSelectVal;
          });
          matchingLocation.forEach((park) => {
            let newDiv = document.createElement("div");
            newDiv.textContent = park.LocationName;
      
            parksPlaceholderEl.appendChild(newDiv);
          });
        };
      
        for (let i = 0; i < parkTypesArray.length; i++) {
          let park = parkTypesArray[i];
          let parkOptionEl = new Option(park);
          parkSelectEl.appendChild(parkOptionEl);
        }
      
        parksPlaceholderEl.innerHTML="";
          let parkselectVal = parkSelectEl.value;
          let matchingDescription = nationalParksArray.filter((park) => {
            return park.LocationName.toLowerCase().includes(parkselectVal.toLowerCase())

          });
          matchingDescription.forEach((park)=>{
            let newDiv = document.createElement("div");
            newDiv.textContent = park.LocationName;
...
//         let optionEl = new Option(option);
//         locationSelectEl.appendChild(optionEl)
//     }
//     for (let i = 0; i < parkTypesArray.length; i++) {
//         let parkoption = parkTypesArray[i];
//         let parkoptionEl = new Option(parkoption);
//         parkSelectEl.appendChild(parkoptionEl);
//     }

//     locationSelectEl.onchange = () =>{
//         for (let i = 0; i <nationalParksArray.length;i++){
//             let newDiv = document.createElement("div");
//             newDiv.textContent = nationalParksArray[i].LocationName;
    
//             placeHolderSelectEl.appendChild(newDiv);
//         }
//     }
